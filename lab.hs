...
--let murka = cat $ CatData "Мурка" 70 80 5 20 Siamese
--printCatInfo barsik
--isHere barsik

--let fedBarsik = feedCat barsik 30
--printCatInfo fedBarsik

--let cat1 = cat $ CatData "Рыжик" 80 90 10 25 MaineCoon
--let cat2 = cat $ CatData "Снежок" 60 70 8 35 Sphynx

--let winner = getWinner cat1 cat2

--let (new1, new2) = battleRound (cat1, cat2)